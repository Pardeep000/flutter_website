...
// class signup__navbar_mobile extends StatelessWidget {
//   const signup__navbar_mobile({Key? key}) : super(key: key);
...
class signup__landingpage_mobile extends StatefulWidget {
  const signup__landingpage_mobile({Key? key}) : super(key: key);

  @override
  State<signup__landingpage_mobile> createState() =>
      _signup__landingpage_mobileState();
}

class _signup__landingpage_mobileState
    extends State<signup__landingpage_mobile> {
  //
